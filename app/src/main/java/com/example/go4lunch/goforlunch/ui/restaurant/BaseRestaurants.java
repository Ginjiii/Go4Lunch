...
import com.example.go4lunch.goforlunch.injections.ViewModelFactory;
...
public abstract class BaseRestaurants extends Fragment implements RestaurantsNavigator, EasyPermissions.PermissionCallbacks {
    ...
    protected RestaurantsViewModel obtainViewModel() {
    ...
    public void noLocationAvailable(){
        viewModel.setValue(new Event<>(R.string.no_location_message));
